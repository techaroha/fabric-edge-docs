...
One of the main modules of the Fabric Edge are **Blockchain** and **State**. <br />
...
The Blockchain Events are the original events that happen in Fabric Edge, and they're later mapped to a Protocol Buffers message format for easy transfer.
:::