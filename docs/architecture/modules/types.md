...
Unlike clients such as GETH, the Fabric Edge doesn't use reflection for the encoding.<br />
...
By manually defining these methods, the Fabric Edge doesn't need to use reflection. In *rlp_marshal.go*, you can find
